...
pub fn build(b: *std.Build) void {
    ...
    b.step("preprocess", "Preprocess zsx → fragments").dependOn(&products_preprocess.step);
    b.step("dev", "Run dev server (Native, Debug)").dependOn(&run_dev.step);
